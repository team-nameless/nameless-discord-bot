...
from nameless.commands.checks.MusicCommandChecks import MusicCommandChecks
...
class MusicCommands(commands.GroupCog, name="music"):
    ...
    @app_commands.check(MusicCommandChecks.user_in_voice)
    ...
    @app_commands.command()
    @app_commands.guild_only()
    @app_commands.check(MusicCommandChecks.bot_in_voice)
    ...
    @app_commands.command()
    @app_commands.guild_only()
    @app_commands.check(MusicCommandChecks.user_and_bot_in_voice)
    @app_commands.check(MusicCommandChecks.bot_is_playing_something)
    ...
    @app_commands.guild_only()
    @app_commands.check(MusicCommandChecks.user_and_bot_in_voice)
    @app_commands.check(MusicCommandChecks.bot_is_silent)
    ...
    @app_commands.guild_only()
    @app_commands.check(MusicCommandChecks.user_and_bot_in_voice)
    @app_commands.check(MusicCommandChecks.bot_must_play_track_not_stream)
    ...
    @app_commands.checks.has_permissions(manage_guild=True)
    @app_commands.check(MusicCommandChecks.user_and_bot_in_voice)
    @app_commands.check(MusicCommandChecks.queue_has_element)
    ...
    @app_commands.check(MusicCommandChecks.user_and_bot_in_voice)
    @app_commands.check(MusicCommandChecks.must_not_be_a_stream)
